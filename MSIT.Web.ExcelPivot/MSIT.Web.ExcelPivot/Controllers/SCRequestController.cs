...
{
    public class SCRequestController : Controller
    {
        
        // GET: SCRequest
        public ActionResult Index()
        {
            if (Session["firstTimeSC"] == null)
            {
                ...
                try
                {
                    ...
                    //ViewBag.Data = result.ToString();
                    string newFileName = @"D:\PivotExcel\MSIT.Web.ExcelPivot\MSIT.Web.ExcelPivot\data.csv";
                    System.IO.File.WriteAllText(newFileName, Convert.ToString(result));
                }
                catch (Exception ex)
                {
                    return View("Error");
            ...
            {
                string newFileName = @"D:\PivotExcel\MSIT.Web.ExcelPivot\MSIT.Web.ExcelPivot\data.csv";
                System.IO.File.WriteAllText(newFileName, Convert.ToString(Session["firstTimeSC"]));
            }
            return View();
        }
    }
