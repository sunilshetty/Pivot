            ...
            try {
                ...
                refreshDelayed = (function (_this) {
                    return function () {
                        ...
                        $('.pvtRendererArea').bind("dblclick", function (obj) {
                            $('#divPanel').html(obj.currentTarget.innerHTML);
                            var dialog = $("#divPanel").dialog({
                                autoOpen: false,
                                height: 700,
                                width: 950,
                                modal: true
                        ...
                        if ($($('#' + $(_this).attr("id") + '.pvtRendererArea').children()[0]).attr('class') == "pvtTable") {
                            $('#' + $(_this).attr("id") + '.pvtRendererArea').html("<div style='overflow:scroll;width:1040px;height:620px;'>" + $('#' + $(_this).attr("id") + '.pvtRendererArea').html() + "</div>");
                        }
